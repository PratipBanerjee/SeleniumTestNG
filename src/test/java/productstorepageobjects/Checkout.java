...
public class Checkout extends BaseClass {
    ...
    {
        BaseClass.WaitForElement(ReadData.ReadObjectRepository("PlaceOrder"));
        driver.findElement(By.xpath(ReadData.ReadObjectRepository("PlaceOrder"))).click();
        BaseClass.WaitForElement(ReadData.ReadObjectRepository("Name"));
        ...
        BaseClass.WaitForElement(ReadData.ReadObjectRepository("PurchaseConfirmation"));
        Thread.sleep(5000);
